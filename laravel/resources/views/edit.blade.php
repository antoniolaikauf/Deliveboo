...
@section('content')
    ...
    <div class="container-fluid bg-sfondo p-5">
        <div class="row justify-content-center py-5">
            <div class="col-md-6 p-4 form-create  text-white">
                    ...
                    <form action="{{ route('dish.update', $dish->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex align-items-center flex-column gap-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                placeholder="Nome piatto" name="name" required id="name" aria-label="Username"
                                aria-describedby="basic-addon1" value="{{ $dish->name }}">
                            @error('name')
                        ...
                        <div class="d-flex align-items-center flex-column my-3 gap-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" aria-label="With textarea"
                                placeholder="Inserisci la descrizione" name="description" required id="description">{{ $dish->description }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="d-flex align-items-center flex-column my-3 gap-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="available" name="available"
                                    value="1" @if ($dish->available == 1) checked @endif>
                        ...
                        <div class="d-flex align-items-center flex-column my-3 gap-3 ">
                            ...
                            @else
                                <div style="width: 100%" class="img">
                                    ...
                                    @else
                                        <img src="{{ asset($dish->img) }}" alt="Immagine del piatto {{ $dish->name }}">
                                    @endif
                                </div>
                            @endif
                            <!-- {{-- Condizione di verifica, se è presente l'img dello storage inserisci quella, altrimenti le img del db(già stabilite) --}}
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            descriptionTextarea.addEventListener("input", function() {
                ...
                // Verifica la lunghezza massima
                    ...
                    descriptionTextarea.setCustomValidity(
                        "La lunghezza non può essere superiore a 200 caratteri");
                }

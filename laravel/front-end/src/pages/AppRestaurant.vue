...
export default {
    ...
    methods: {
        ...
        addToCart(dish) {
            ...
            // si emette un evento globale chiamato cart-updated. Questo evento non trasporta
            // dati; la sua unica funzione è notificare che c'è stato un aggiornamento.
        ...
        for (let i = 0; i < this.selectedRestaurant.user.dishes.length; i++) {
            ...
            if (this.selectedRestaurant.user.dishes[i].img.startsWith("i")) {
                ...
                axios
                    ...
                    .then((res) => {
                        this.selectedRestaurant.user.dishes[i].img =
                            res.data.risposta;
                        // console.log(res.data.risposta);
                    })
                    .catch((err) => {
